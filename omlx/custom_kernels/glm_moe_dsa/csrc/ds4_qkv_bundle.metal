...
// One heterogeneous grid for both exact bodies above. Threadgroups [0,96)
// host two virtual 64-thread MXFP8 groups (four simdgroups split 2+2), covering
// 1,536 Q-A/KV rows at 16 rows per physical group. Threadgroups [96,256)
// run the unchanged four-simdgroup dense body at 16 rows per group. This is
// dispatch coalescing only: lane K walks and reduction trees are identical.
[[kernel, max_total_threads_per_threadgroup(128)]] void
