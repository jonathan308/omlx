...
#define instantiate_qwen4_sparse_gqa_split(tname, dtype, bk, dc)               \
  instantiate_kernel("qwen4_qsa_sparse_gqa_split_" #tname "_bk" #bk "_dc" #dc  \
                     "_gqa12_hp16_d256_wm2",                                   \
                     qwen4_qsa_sparse_gqa_attention, dtype, bk, dc, 12,       \
                     16, 256, 2, uint, float, true)

instantiate_qwen4_sparse_gqa_split(float16, half, 128, 32);
instantiate_qwen4_sparse_gqa_split(bfloat16, bfloat16_t, 128, 32);
