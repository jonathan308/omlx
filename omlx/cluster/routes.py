...
class _UnpromotablePerformanceCalibrationError(ValueError):
    ...
    if existing_profiles:
        ...
        try:
            ...
            if performance_probe.get("promotable") is False:
                raise _UnpromotablePerformanceCalibrationError(
                    str(
        ...
        except _UnpromotablePerformanceCalibrationError as exc:
            profiled_request_nodes = list(ordered_request_nodes)
            performance_probe = {
                "ok": False,
                "promotable": False,
